...
public class RestaurantMenuUtils {
    ...
    public RestaurantMenuUtils(AddRestaurantController addRestaurantController, RemoveRestaurantController removeRestaurantController, ShowRestaurantsController showRestaurantsController, UpdateRestaurantController updateRestaurantController, ConsoleUtils console) {
    ...
    public void showMenu() {
        boolean exit = false;
        while (!exit) {
            System.out.println("Opciones de Restaurantes:");
